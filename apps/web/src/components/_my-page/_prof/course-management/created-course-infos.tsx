...
import type { FetchCreatedCoursesReturnType } from "@lms-repo/db/utils/query/courses";
...
import { CreateAnnouncementForm } from "@/components/_my-page/_prof/course-management/create-announcement-form";
import { CreateAssignmentForm } from "@/components/_my-page/_prof/course-management/create-assignment-form";
...
interface CreatedCourseInfosProps {
	courseWithCoverImage?: FetchCreatedCoursesReturnType[number] & {
		coverImage?: string;
	};
...
export default function CreatedCourseInfos({
	courseWithCoverImage,
	announcements,
	assignments,
	courseId,
}: CreatedCourseInfosProps) {
